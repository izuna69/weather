...
| 버전  | 일자       | 주요 기능 요약                                                         | 다운로드 |
|--------|------------|------------------------------------------------------------------------|-----------|
| Main   | 2025-06-01 | ✔ 현재 위치 기반 날씨<br>✔ 미세먼지 정보<br>✔ 시간별/주간 예보<br>✔ 지역 즐겨찾기 | [📦 APK 다운로드](https://github.com/izuna69/weather/releases/download/Main/weather_clean_fixed.apk) |
